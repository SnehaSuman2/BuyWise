...
RETAILERS: list[dict] = [
    {
        ...
        "policies": {
            ...
            "established_year_in_india": 2013,
            "parent_company": "Amazon.com, Inc.",
            "verified_purchase_reviews": True,
    ...
    },
    {
        ...
        "policies": {
            ...
            "grievance_officer_published": True,
            "established_year_in_india": 2007,
    ...
    },
    {
        ...
        "policies": {
            ...
            "established_year_in_india": 2006,
            "parent_company": "Tata Sons (Infiniti Retail Ltd)",
            "customer_support_published": True,
            "verified_on": "2026-09-01",
        },
    },
    {
        ...
        "policies": {
            ...
            "physical_stores": True,
            "established_year_in_india": 2007,
            "parent_company": "Reliance Retail Ltd",
            "customer_support_published": True,
            "verified_on": "2026-09-01",
        },
    },
    {
        ...
        "policies": {
            ...
            "cod_available": True,
            "established_year_in_india": 2016,
            "parent_company": "Tata UniStore Ltd",
            "authorised_sellers_only": True,
            "customer_support_published": True,
            "verified_on": "2026-09-01",
        },
    },
    {
        ...
        "policies": {
            "publishes_return_policy": True,
            "physical_stores": True,
            "established_year_in_india": 1967,
            "customer_support_published": True,
            "verified_on": "2026-09-01",
        },
    },
    ...
    },
    {
        ...
        "policies": {
            "publishes_return_policy": True,
            "cod_available": True,
            "established_year_in_india": 2012,
            "parent_company": "FSN E-Commerce Ventures Ltd",
            "authorised_sellers_only": True,
            "customer_support_published": True,
            "verified_on": "2026-09-01",
        },
