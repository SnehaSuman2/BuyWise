...
KNOWN_INDIAN_NAMES = {
    "cashify", "zepto", "gadgets now", "easyphones", "vijay sales", "sangeetha mobiles",
    "poorvika", "reliance digital", "croma", "tata cliq", "tata cliq luxury", "jiomart",
    "bigbasket", "blinkit", "snapdeal", "meesho", "flipkart", "myntra", "ajio", "nykaa",
    "lenskart", "firstcry", "pepperfry", "headphone zone", "the it depot", "md computers",
    "prime abgb", "vedant computers", "shopclues", "paytm mall", "indiamart", "moglix",
}

# Country-code TLDs that clearly indicate a non-Indian storefront.
FOREIGN_TLDS = {
    ".jp", ".co.jp", ".uk", ".co.uk", ".tz", ".co.tz", ".tr", ".com.tr", ".de", ".fr",
    ".it", ".es", ".nl", ".be", ".se", ".no", ".dk", ".fi", ".pl", ".pt", ".gr", ".ch",
    ".at", ".ie", ".cz", ".ro", ".hu", ".ua", ".ru", ".cn", ".com.cn", ".hk", ".tw",
    ".kr", ".co.kr", ".sg", ".com.sg", ".my", ".com.my", ".id", ".co.id", ".ph",
    ".com.ph", ".th", ".co.th", ".vn", ".com.vn", ".pk", ".com.pk", ".bd", ".com.bd",
    ".lk", ".np", ".ae", ".sa", ".com.sa", ".qa", ".kw", ".bh", ".om", ".il", ".co.il",
    ".za", ".co.za", ".ke", ".co.ke", ".ng", ".com.ng", ".eg", ".ma", ".gh", ".au",
    ".com.au", ".nz", ".co.nz", ".ca", ".mx", ".com.mx", ".br", ".com.br", ".ar",
    ".com.ar", ".cl", ".co", ".pe", ".us", ".me", ".tv", ".cc", ".ws",
    ".eu", ".asia", ".africa", ".sk", ".si", ".hr", ".bg", ".lt", ".lv", ".ee",
    ".is", ".lu", ".mt", ".cy", ".by", ".kz", ".uz", ".ge", ".am", ".az",
}
...
AGGREGATOR_DOMAINS = {
    "google.com", "google.co.in", "googleadservices.com", "googleusercontent.com",
    "bing.com", "shopping.google.com", "serpapi.com",
}
...
FOREIGN_PLACE_WORDS = {
    "tanzania", "kenya", "nigeria", "uganda", "ghana", "dubai", "uae", "qatar",
    "kuwait", "bahrain", "oman", "saudi", "singapore", "malaysia", "indonesia",
    "philippines", "thailand", "vietnam", "japan", "tokyo", "china", "shanghai",
    "korea", "taiwan", "hong kong", "turkey", "istanbul", "russia", "brazil",
    "mexico", "canada", "australia", "new zealand", "pakistan", "bangladesh",
