  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-12 prose-sm">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <section><h2 className="font-semibold text-lg mb-2">4. Third-party processors</h2><p>We use search and product-data APIs (such as SerpApi or SearchApi), AI providers for explanations (product data only, never your account details), an email delivery provider, Razorpay for payments, Google Analytics for aggregate usage statistics, and hosting/database providers. Each processes data only to provide its service to us.</p></section>
        <section><h2 className="font-semibold text-lg mb-2">5. Cookies and local storage</h2><p>We use browser local storage to keep you signed in and remember preferences such as dark mode. We use Google Analytics to understand how the site is used in aggregate (pages viewed, searches made, which retailers people visit); it sets its own cookies, IP addresses are anonymised, and we never send it your name, email, account id or order details. We do not use third-party advertising cookies.</p></section>
